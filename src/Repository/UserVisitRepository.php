...
/**
 * @extends ServiceEntityRepository<UserVisit>
 *
...
class UserVisitRepository extends ServiceEntityRepository
{
    ...
    public function save(UserVisit $entity, bool $flush = false): void
    {
    ...
    public function remove(UserVisit $entity, bool $flush = false): void
    {
